...
//   { label: "Listed Universities", value: "100+" },
//   { label: "Program Rating", value: "4.6/5" },
//   { label: "Learner Associated", value: "10,000+" },
// ];
...
//               size="lg"
//               variant="outline"
//               className="rounded-full border-border/40 bg-background/60 px-8 text-base text-foreground/80 backdrop-blur transition-all hover:border-primary hover:text-primary hover:bg-transparent dark:border-border/50 dark:bg-background/40 dark:text-foreground/70 dark:hover:border-primary dark:hover:text-primary dark:hover:bg-transparent"
//             >
