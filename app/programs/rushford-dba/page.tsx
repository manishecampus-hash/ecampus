          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                Earn a globally relevant Doctor of Business Administration
                designed for senior professionals who want strategic leadership,
                research capability, and business transformation expertise.
              </p>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 md:px-8">
        <div className="rounded-[32px] border border-slate-100 p-8 md:p-12">
          ...
          <p className="mt-6 max-w-4xl text-lg leading-8 text-slate-600">
            The Rushford Online DBA equips experienced professionals with
            advanced research skills, strategic thinking, innovation frameworks,
            and leadership capability to solve real-world business challenges.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl bg-slate-50 p-6">
              ...
              <ul className="mt-4 space-y-3 text-slate-600">
                ...
                <li>• Strategic leadership and transformation</li>
                <li>• Innovation and global business frameworks</li>
                <li>• Applied doctoral research</li>
              </ul>
            </div>
            ...
            <div id="apply" className="rounded-3xl bg-slate-50 p-6">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Advance toward executive leadership with a doctoral program
                designed for ambitious professionals and decision-makers.
              </p>
