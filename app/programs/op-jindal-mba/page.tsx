...
export default function Page() {
  ...
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-slate-100 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-red-50/50 via-slate-50 to-white pt-10 pb-20 lg:pt-16 lg:pb-24">
        {/* Background Decor */}
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-xl text-lg leading-relaxed text-slate-600">
                  ...
                  for professionals who want leadership, business strategy, and
